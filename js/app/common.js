...
snapIt.common.normalStyle = {top:'45px',bottom:0};
snapIt.common.centerStyle = {top:'45px',bottom:'50px'};
snapIt.common.normalPage = function(id, options){
	var opt = $.extend({}, options, snapIt.common.normalStyle);
	return snapIt.common.page(id, {styles : opt});
};
snapIt.common.centerPage = function(id, options){
	var opt = $.extend({}, options, snapIt.common.normalStyle);
	return snapIt.common.page(id, {styles : opt});
};
...
snapIt.common.currentPage = function(){
